...
download/
├── main/
│   ├── python/          # ← THƯ MỤC CHỨA SCRIPT PYTHON
│   │   ├── main.py      # ← Script chính xử lý tải video
│   │   └── server.py    # ← Script server chia sẻ LAN
...
│   └── ... 
└── run.bat              # ← CHẠY FILE NÀY ĐỂ KHỞI ĐỘNG (tự động gọi python/main.py)
```
